...
const BookingModal = ({ isOpen, onClose, selectedService, selectedDate }) => {
    ...
    const handleOpenMap = () => {
        // Open Google Maps in a new tab centered on user's current position if available, or just a general search
        window.open('https://www.google.com/maps/search/?api=1&query=address', '_blank');
        alert("Please find your location on Google Maps, copy the address, and paste it here.");
    };
...
Service: ${formData.service || selectedService}`;
    ...
    return (
        ...
        >
            <div
                className="relative bg-white w-full max-w-[460px] flex flex-col rounded-[2rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 ease-out"
                onClick={e => e.stopPropagation()}
            >
                {/* Visual Header Accent */}
                <div className="h-1.5 w-full bg-gradient-to-r from-lime-400 via-lime-500 to-lime-600 shrink-0" />
                ...
                <div className="p-6 sm:p-8">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-gray-500 text-[10px] sm:text-xs font-medium leading-relaxed">
                            Professional cleaning service at your doorstep.
                        </p>
                    </div>
